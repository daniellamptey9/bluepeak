...
<head>
    ...
    <title>{{ config('app.name', 'BluePeak MSP') }} - @yield('title', 'Professional IT Services & Cloud Solutions')</title>
...
<body class="font-sans antialiased bg-white">
        ...
        <div class="container-custom">
            <div class="flex items-center justify-between h-20 py-4">
                ...
                <div class="flex items-center justify-start">
                    <a href="{{ route('home') }}" class="flex items-center hover:opacity-80 transition-opacity">
                        <img src="{{ asset('bluebridge.png') }}" alt="Bluebridge IT Solutions" class="h-16 w-auto">
                    </a>
                </div>
                ...
                <div class="flex items-center justify-center">
                    ...
                    <div class="relative group">
                        ...
                        <div class="absolute top-full right-0 mt-2 w-96 max-w-[calc(100vw-2rem)] bg-white rounded-xl shadow-2xl border border-secondary-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                            <div class="p-8">
                                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                                    <!-- IT Services Column -->
                                    <div>
                                        <h3 class="text-lg font-semibold text-secondary-900 mb-4">IT Services</h3>
                                        <div class="space-y-3">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-semibold text-secondary-900 mb-4">Cloud Services</h3>
                                        <div class="space-y-4">
                                    ...
                                    <!-- Sectors Column -->
                                    <div>
                                        <h3 class="text-lg font-semibold text-secondary-900 mb-4">Sectors</h3>
                                        <div class="space-y-4">
                                            <a href="{{ route('service.detail', 'manufacturing') }}" class="block p-4 rounded-lg hover:bg-primary-50 transition-colors group">
                                                <div class="flex items-center space-x-4">
                                                    <div class="w-10 h-10 bg-orange-100 rounded-lg flex items-center justify-center">
                                                        <svg class="w-5 h-5 text-orange-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                                    ...
                                                    <div>
                                                        <div class="font-medium text-secondary-900 group-hover:text-primary-600">Manufacturing</div>
                                                        <div class="text-sm text-secondary-600">IT support for manufacturing businesses</div>
                                                    </div>
                                                </div>
                                            </a>
                                            
                                            <a href="{{ route('service.detail', 'finance') }}" class="block p-4 rounded-lg hover:bg-primary-50 transition-colors group">
                                                <div class="flex items-center space-x-4">
                                                    <div class="w-10 h-10 bg-green-100 rounded-lg flex items-center justify-center">
                                                        <svg class="w-5 h-5 text-green-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <div>
                                                        <div class="font-medium text-secondary-900 group-hover:text-primary-600">Finance</div>
                                                        <div class="text-sm text-secondary-600">IT solutions for financial services</div>
                                                    </div>
                                                </div>
                                            </a>
                                            
                                            <a href="{{ route('service.detail', 'law-firms') }}" class="block p-4 rounded-lg hover:bg-primary-50 transition-colors group">
                                                <div class="flex items-center space-x-4">
                                                    <div class="w-10 h-10 bg-blue-100 rounded-lg flex items-center justify-center">
                                                        <svg class="w-5 h-5 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <div>
                                                        <div class="font-medium text-secondary-900 group-hover:text-primary-600">Law Firms</div>
                                                        <div class="text-sm text-secondary-600">Secure IT solutions for legal practices</div>
                                                    </div>
                                                </div>
                                            </a>
                                            
                                            <a href="{{ route('service.detail', 'healthcare') }}" class="block p-4 rounded-lg hover:bg-primary-50 transition-colors group">
                                                <div class="flex items-center space-x-4">
                                                    <div class="w-10 h-10 bg-red-100 rounded-lg flex items-center justify-center">
                                                        <svg class="w-5 h-5 text-red-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                    ...
                                                    <div>
                                                        <div class="font-medium text-secondary-900 group-hover:text-primary-600">Healthcare</div>
                                                        <div class="text-sm text-secondary-600">HIPAA-compliant IT for healthcare providers</div>
                                                    </div>
                                                </div>
                                            </a>
                                            
                                            <a href="{{ route('service.detail', 'construction') }}" class="block p-4 rounded-lg hover:bg-primary-50 transition-colors group">
                                                <div class="flex items-center space-x-4">
                                                    <div class="w-10 h-10 bg-yellow-100 rounded-lg flex items-center justify-center">
                                                        <svg class="w-5 h-5 text-yellow-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                                                    ...
                                                    <div>
                                                        <div class="font-medium text-secondary-900 group-hover:text-primary-600">Construction</div>
                                                        <div class="text-sm text-secondary-600">IT support for construction companies</div>
                                                    </div>
                                                </div>
                                            </a>
                                        </div>
                                ...
                                <div class="mt-8 pt-6 border-t border-secondary-100">
                                    <div class="flex items-center justify-between">
                                        <div>
                                            <h4 class="font-semibold text-secondary-900">Need a custom solution?</h4>
                                            <p class="text-sm text-secondary-600">We can tailor our services to meet your specific needs.</p>
                                        </div>
                    ...
                    <a href="#team" class="text-secondary-700 hover:text-primary-600 transition-colors">Team</a>
                    <a href="#testimonials" class="text-secondary-700 hover:text-primary-600 transition-colors">Testimonials</a>
            ...
            <div class="md:hidden hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 bg-white border-t">
                    ...
                    <div class="px-3 py-2">
                        <button class="flex items-center justify-between w-full text-secondary-700 hover:text-primary-600 transition-colors" id="mobile-services-toggle">
                            <span>Services</span>
                            <svg class="w-4 h-4 transition-transform" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                            </svg>
                        </button>
                        <div class="hidden mt-2 space-y-2" id="mobile-services-menu">
                            <div class="pl-6">
                                <div class="text-xs font-semibold text-secondary-500 uppercase tracking-wide mb-2">IT Services</div>
                                <div class="space-y-1 mb-4">
                                    <a href="{{ route('service.detail', 'it-support') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">IT Support</a>
                                    <a href="{{ route('service.detail', 'cybersecurity') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Cyber Security</a>
                                    <a href="{{ route('service.detail', 'cybersecurity-awareness-training') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Cyber Security Awareness Training</a>
                                    <a href="{{ route('service.detail', 'it-remote-support') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">IT Remote Support</a>
                                    <a href="{{ route('service.detail', 'maintenance-contracts') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Maintenance Contracts</a>
                                    <a href="{{ route('service.detail', 'small-business-it-support') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Small Business IT Support</a>
                                    <a href="{{ route('service.detail', 'it-helpdesk') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">IT Helpdesk</a>
                                    <a href="{{ route('service.detail', 'managed-services') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Managed IT Services</a>
                                </div>
                                
                                <div class="text-xs font-semibold text-secondary-500 uppercase tracking-wide mb-2">Cloud Services</div>
                                <div class="space-y-1 mb-4">
                                    <a href="{{ route('service.detail', 'office-365') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Office 365</a>
                                    <a href="{{ route('service.detail', 'office-365-support') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Office 365 Support</a>
                                    <a href="{{ route('service.detail', 'office-365-backup') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Office 365 Backup</a>
                                    <a href="{{ route('service.detail', 'microsoft-teams') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Microsoft Teams</a>
                                    <a href="{{ route('service.detail', 'microsoft-azure') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Microsoft Azure</a>
                                    <a href="{{ route('service.detail', 'azure-virtual-machines') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Azure Virtual Machines</a>
                                    <a href="{{ route('service.detail', 'azure-storage') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Azure Storage</a>
                                    <a href="{{ route('service.detail', 'azure-backup') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Azure Backup</a>
                                    <a href="{{ route('service.detail', 'google-workspace') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Google Workspace</a>
                                    <a href="{{ route('service.detail', 'amazon-web-services') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Amazon Web Services</a>
                                    <a href="{{ route('service.detail', 'cloud-migration') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Cloud Migration</a>
                                </div>
                                
                                <div class="text-xs font-semibold text-secondary-500 uppercase tracking-wide mb-2">Sectors</div>
                                <div class="space-y-1">
                                    <a href="{{ route('service.detail', 'healthcare') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Healthcare</a>
                                    <a href="{{ route('service.detail', 'law-firms') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Law Firms</a>
                                    <a href="{{ route('service.detail', 'finance') }}" class="block py-1 text-sm text-secondary-600 hover:text-primary-600">Finance</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <a href="#team" class="block px-3 py-2 text-secondary-700 hover:text-primary-600 transition-colors">Team</a>
                    <a href="#testimonials" class="block px-3 py-2 text-secondary-700 hover:text-primary-600 transition-colors">Testimonials</a>
        ...
        <div class="container-custom section-padding">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div class="md:col-span-2">
                    <div class="mb-4">
                        <img src="{{ asset('images/asset.png') }}" alt="BluePeak MSP" class="h-12 w-auto" style="filter: brightness(0) invert(1);">
                    </div>
            ...
            <div class="border-t border-secondary-700 mt-8 pt-8 text-center text-secondary-300">
                <p>&copy; {{ date('Y') }} BluePeak MSP. All rights reserved.</p>
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        document.addEventListener('click', function(event) {
            ...
            if (servicesGroup && !servicesGroup.contains(event.target)) {
                // Remove hover state if needed
                servicesGroup.classList.remove('hover:opacity-100', 'hover:visible');
            }
        });
    </script>
