                        ...
                        <div class="absolute top-full left-1/2 transform -translate-x-1/2 mt-2 w-screen max-w-4xl bg-white rounded-xl shadow-2xl border border-secondary-100 opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-300 z-50">
                            <div class="p-6">
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="space-y-3">
                                        <a href="{{ route('service.detail', 'it-support') }}" class="block p-3 rounded-lg hover:bg-primary-50 transition-colors group">
                                        ...
                                        <a href="{{ route('service.detail', 'cybersecurity') }}" class="block p-3 rounded-lg hover:bg-primary-50 transition-colors group">
                                            <div class="flex items-center space-x-3">
                                        ...
                                        <a href="{{ route('service.detail', 'cybersecurity-awareness-training') }}" class="block p-3 rounded-lg hover:bg-primary-50 transition-colors group">
                                            <div class="flex items-center space-x-3">
                                    ...
                                    <div class="space-y-3">
                                        <a href="{{ route('service.detail', 'it-remote-support') }}" class="block p-3 rounded-lg hover:bg-primary-50 transition-colors group">
                                            <div class="flex items-center space-x-3">
                                        ...
                                        <a href="{{ route('service.detail', 'maintenance-contracts') }}" class="block p-3 rounded-lg hover:bg-primary-50 transition-colors group">
                                            <div class="flex items-center space-x-3">
                                        ...
                                        <a href="{{ route('service.detail', 'small-business-it-support') }}" class="block p-3 rounded-lg hover:bg-primary-50 transition-colors group">
                                            <div class="flex items-center space-x-3">
                                    ...
                                    <div class="space-y-3">
                                        <a href="{{ route('service.detail', 'it-helpdesk') }}" class="block p-3 rounded-lg hover:bg-primary-50 transition-colors group">
                                            <div class="flex items-center space-x-3">
                                        ...
                                        <a href="{{ route('service.detail', 'managed-services') }}" class="block p-3 rounded-lg hover:bg-primary-50 transition-colors group">
                                            <div class="flex items-center space-x-3">
                                        ...
                                        <a href="{{ route('services.index') }}" class="block p-3 rounded-lg bg-primary-50 hover:bg-primary-100 transition-colors text-center">
